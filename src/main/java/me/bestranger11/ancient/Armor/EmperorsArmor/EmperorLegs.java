...
public class EmperorLegs {

    public static ItemStack EmperorLegs;
    private final Main main;

    public EmperorLegs(Main main) {
        this.main = main;
    }
    ...
    private static void createEmperorLegs() {
        ItemStack item = new ItemStack(Material.NETHERITE_LEGGINGS, 1);
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(ChatColor.RED + "Emperors Leg Covers");
        int amountPts = 6;
